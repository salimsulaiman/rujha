...
@section('content')
    <div class="w-full">
        <div class="w-full h-[300px] bg-cover bg-center flex flex-col items-center justify-center"
            ...
            <h1 class="text-slate-600 font-semibold text-4xl mt-12">kemeja batik</h1>
        </div>
        <div class="w-full max-w-7xl px-8 mx-auto bg-white py-8">
            <div class="w-full overflow-x-auto py-2 md:py-0">
                <div class="flex gap-3 min-w-max px-1 py-2">
                    <!-- Tombol "Terbaru" -->
                    <button
                        class="shrink-0 px-4 py-2 rounded-full bg-Whisper-50 text-slate-700 font-medium whitespace-nowrap">
                        Terbaru
                    </button>

                    <!-- Filter Kategori -->
                    <a href="#"
                        class="shrink-0 px-4 py-2 rounded-full bg-white hover:bg-slate-200 text-slate-700 whitespace-nowrap">
                        Kemeja
                    </a>
                    <a href="#"
                        class="shrink-0 px-4 py-2 rounded-full bg-white hover:bg-slate-200 text-slate-700 whitespace-nowrap">
