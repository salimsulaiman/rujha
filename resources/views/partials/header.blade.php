<header x-data="{ menuToggle: false }" class="sticky top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-between lg:border-b-0 lg:px-0 lg:py-4">
            ...
            <a href="index.html" class="lg:hidden">
                <h1 class="text-slate-700 text-xl">rujha</h1>
            </a>
